...
public abstract class MeteSaca<T> {
    ...
    /**
     * Nos permite ver el elemento en un extremo de la estructura, sin sacarlo de la
     * misma.
     * 
     * @return el elemento en un extremo de la estructura.
     * @throws NoSuchElementException si la estructura está vacía.
     ...
     * 
     * @return <tt>true</tt> si la estructura no tiene elementos, <tt>false</tt> en
     *         otro caso.
     */
     ...
     * @return <code>true</code> si el objeto recibido es una instancia de la misma
     *         clase que la estructura, y sus elementos son iguales en el mismo
     *         orden; <code>false</code> en otro caso.
     */
    @Override
