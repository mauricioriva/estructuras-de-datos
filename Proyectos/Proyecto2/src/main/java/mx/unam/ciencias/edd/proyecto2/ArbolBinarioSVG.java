...
/* Clase abstracta para crear Arboles Binarios en SVG */
public abstract class ArbolBinarioSVG implements ArbolGrafico{

	/* Arbol a representar en SVG */
	public ArbolBinario<Integer> ab;
	 ...
	 * @param v El vertice a dibujar que tiene propiedades como su elemento.
