...
public class ArbolRojinegroSVG {
	...
	public String imprime() {
		...
		int height = height(ab.altura()) + 15;
		...
		res = res + conexiones(width,ab.raiz(), width / 2, 35);
	...
	public String dibuja(VerticeArbolBinario<Palabra> v, double x, int y) {
		...
		s = "\t<circle cx='" + x + "' cy='" + y + "' r='30' stroke='"+ c +"' stroke-width='3' fill='"+ c +"' />\n";
